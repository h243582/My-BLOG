package com.heyufei.recruit.controller;
...
import com.heyufei.recruit.service.RecruitService;
...
public class RecruitController {
	...
	public Result recommend(){
		List<Recruit> list = recruitService.findTop4ByStateOrderByCreatetimeDesc("2");//2是推荐
